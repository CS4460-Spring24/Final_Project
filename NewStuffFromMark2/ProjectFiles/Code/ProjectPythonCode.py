# This code contains the functions needed to answer the 
# computational challenges in our Final Project


# these fist 2 blocks of code were taken from the GeeksforGeeks website
# https://www.geeksforgeeks.org/multiplicative-inverse-under-modulo-m/
# this fucntion takes 2 positive integers and returns their gcd
# However, Mark constructed similar code that accomplished the same
# thing from a previous CS 3430 assignment.
def gcdExtended(a, b):
    global x, y
...
# specifically, n = 7*17 = 259, e = 59, d = 11
def encrypt(array):
    encrypt = []
    for num in array:
        temp = 1
...
# this is specific to the RSA encryption for the
# medium RSA challenge: n = 7*37 = 259, e = 59, d = 11
def decrypt(array):
    decrypt = []
    for num in array:
        temp = 1
